...
author: Adrian
description: >
    This book is a bit different from what I usually read; I picked it from the bookstore shelf because I was drawn by its title and my interest in grand strategy. My lasting impression while reading this book is that it requires some pre-reading...
thumbnail: assets/img/book-on-grand-strategy.jpg
---
<div class="row mt-3">
    <div class="col-sm-6 offset-sm-3 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/book-on-grand-strategy.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
    On Grand Strategy - 'Extraordinary ... A Training Manual for Our Troubled Times' the Times
</div>
...
My lasting impression while reading this book is that it requires some pre-reading, such as Isaiah Berlin's essays, Tolstoy's _War and Peace_, or Clausewitz's _On War_. I, of course, had read none of them. Therefore, I didn't get the full picture of what the book was saying on many occasions. Another impression is that it has difficult English vocabulary and style, akin to what you might find in a GRE test. I believe it would not be strange to find a passage from this book in the reading comprehension section of that exam.
...
If you are interested in this topic and have already read Tolstoy or Clausewitz, it can be an interesting read. However, I had hoped to learn more from this book. The language is unnecessarily difficult, it requires a great deal of pre-reading (that was on me), and most importantly, I didn't learn very much about grand strategy itself (hence the prerequisites in university courses).
